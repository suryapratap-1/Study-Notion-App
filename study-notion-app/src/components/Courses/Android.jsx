...
import { androidInfo } from '../../data/courseInfoList'
                ...
                <div>
                    <div className='border border-gray-500'>
                      <div onClick={() => setSection1Clicked(!section1Clicked)}
                          ...
                          <p className='text-lg text-yellow-400'>2 Lecture(s)</p>
                      </div>
                      <div 
          ...
          <div className='w-[35%] h-[600px] bg-slate-700 p-4 rounded-xl'>
            <div className='flex flex-col gap-4'>
              <img className='rounded-xl'
                src={androidInfo.image} alt="" 
              />
              <div className='px-3 flex flex-col gap-3'>
                  <h3 className='text-3xl font-bold text-white'>{androidInfo.price}</h3>
                  <div className='flex flex-col gap-4'>
                    <NavLink to='signup'>
